...
"""
//step2 string to data
let jsonData = jsonString.data(using: .utf8)!


//step3 create a swift type
...
struct Weekday1:Decodable{
    var en: String
}

struct Month1:Decodable{
    var number: Int
    var en: String
}
...
struct Hijri:Decodable{
    ...
    var format: String
    var day: String
    var weekday: Weekday2
    var month: Month2
    var year: String
    var designation: Designation2
    var holidays: [String]
}
struct Weekday2:Decodable{
    var en: String
    var ar: String
    
}

struct Month2:Decodable{
    var number: Int
    var en: String
    var ar: String
...
//step4 decode from data to swift

class Jason: ObservableObject{
    @Published var time: PrayData?
    ...
    func fetchPrayerTimes(){
        ...
        do{
             time = try decoder.decode(PrayData.self, from: jsonData)
            
            
            
            // using for
//            for i in time.data{
//                if i.date.readable == result{
//                    print(i.timings)
//                }
//            }
    ...
    func getPrayerTimeForToday() -> Timings? {
        return time?.data.first(where: { $0.date.readable == currentDate })?.timings
    }
